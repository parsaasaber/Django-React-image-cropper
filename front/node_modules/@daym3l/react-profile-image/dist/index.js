...
var UploadBtn = function UploadBtn(_ref) {
  ...
  var randomId = "contained-button-file-" + Math.random();
...
var imageUpload = function imageUpload(props) {
  ...
  var _uploadBtnProps$label = uploadBtnProps.label,
      uploadBtnLabel = _uploadBtnProps$label === undefined ? 'Upload' : _uploadBtnProps$label,
      _up = uploadBtnProps.onClick,
      restUploadBtnProps = _objectWithoutProperties(uploadBtnProps, ["label", "onClick"]);

  var _cameraBtnProps$label = cameraBtnProps.label,
      cameraBtnLabel = _cameraBtnProps$label === undefined ? 'Camera' : _cameraBtnProps$label,
      _cam = cameraBtnProps.onClick,
      restCameraBtnProps = _objectWithoutProperties(cameraBtnProps, ["label", "onClick"]);

  var _cancelBtnProps$label = cancelBtnProps.label,
      cancelBtnLabel = _cancelBtnProps$label === undefined ? 'Cancel' : _cancelBtnProps$label,
      _can = cancelBtnProps.onClick,
      restCancelBtnProps = _objectWithoutProperties(cancelBtnProps, ["label", "onClick"]);

  var _takeBtnProps$label = takeBtnProps.label,
      takeBtnLabel = _takeBtnProps$label === undefined ? 'Take' : _takeBtnProps$label,
  ...
  var _React$useState3 = _react2.default.useState(null),
      ...
      imagefile = _React$useState4[0],
      setImageFile = _React$useState4[1];
  ...
  var _React$useState7 = _react2.default.useState(false),
      ...
      webCam = _React$useState8[0],
      setWebCamVisibility = _React$useState8[1];

  var firstImgRef = _react2.default.useRef(defaultImage);
  ...
  var IMAGE_VIEW = _react2.default.createElement("img", { style: styles, alt: "Image preview", src: clearPreview ? firstImgRef.current : image });
  ...
  return _react2.default.createElement(
    "div",
    { style: { width: styles.width, borderRadius: styles.borderRadius, display: 'flex', flexDirection: 'column', justifyContent: 'center', position: 'relative' } },
...
imageUpload.propTypes = {
  ...
  clearPreview: _propTypes2.default.bool
};
